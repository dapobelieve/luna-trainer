      ...
      <div class="px-4 py-2" style="overflow: scroll">
        <div class="flex flex-row">
          ...
          <p class="w-1/4 flex justify-end py-4">
            <i class="fi-rr-cross text-lg cursor-pointer text-primary-color" @click="closeModal"></i>
          </p>
        </div>
        ...
        <div v-if="isWeekSelected" class="py-4">
        ...
        <div v-if="isMonthSelected" class="py-4 flex w-[200px]">
          <date-picker
            v-model="montSelect"
