<template>
  <div>
    <template v-if="readNotifications.length">
      ...
      />
      <button v-if="this.readNotifications.length >= this.page * this.limit || loadingMore " @click.prevent="loadMore"  class="btn block w-full py-2 font-bold text-center flex items-center">
