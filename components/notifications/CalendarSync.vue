<template>
  <div class="cursor-pointer flex items-center gap-4 py-4 px-3 rounded-lg hover:bg-gray-100 mb-2" :class="[status ==='UNREAD' ? 'bg-gray-100' : '']" @click.stop="">
...
export default {
  ...
  computed: {
    status () {
      return this.notification ? this.notification.status : false
    },
    message () {
