    ...
    <div class="left-card">
      <form autocomplete="off" class="tail-grid tail-gap-6">
        <div class="tail-border tail-rounded tail-p-4">
          <div>
            <div class="tail-py-2">
              <h1 class="tail-font-medium">Customer</h1>
            </div>
            <div class="tail-pb-4">
          ...
          <div class="tail-pb-8">
            ...
            <button v-else class="base-button tail-mt-1">
              Invite a client
            </button>
        ...
        <div class="tail-border tail-rounded tail-p-4">
          ...
          <div class="tail-pb-4">
            ...
            <button v-else class="base-button tail-mt-1" @click.prevent="$router.push({ name: 'Settings' })">
              Add a service
            </button>
            <small style="color: red" class="tail-text-center">
