      ...
      <div class="pl-3 pr-1 py-0.5 h-8 justify-between flex items-center ">
        <ClickOutside :do="() => { showFieldDropdown = false }">
          <div class="relative cursor-pointer mr-4 items-center inline-flex text-sm">
            ...
            <div v-show="showFieldDropdown" class="top-[18px] absolute mt-2 right-[-10px] rounded shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-40">
        ...
        <div class="w-[160px] flex items-center justify-start">
          ...
          <input
            ...
            @focus="show = true"
          />
          <button v-if="selectedOption || field" class="border ml-auto rounded-full h-4 w-4" @click="reset">
