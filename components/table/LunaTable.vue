      ...
      <div class="overflow-scroll lg:overflow-x-hidden rounded-2xl">
        <table class="table-auto table w-full text-xs" align="center">
          ...
          <tbody v-if="tableData.length">
            <tr v-for="(tableItem, itemIndex) in tableData" :key="itemIndex" class="text-center text-gray-500 hover-row hover:cursor-pointer" @click.exact="$emit('item-clicked', tableItem)">
