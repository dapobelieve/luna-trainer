      ...
      <template v-slot:content>
        ...
        <div class="overflow-scroll lg:overflow-hidden">
          <table class="table-auto table bg-white w-full text-xs rounded-md">
            ...
            <tbody>
              <tr v-for="(data) in filteredRecords" :key="data._id" class="text-center relative text-gray-500 hover-row hover:cursor-pointer" @click.prevent="$router.push({ name: `myFiles-googleDrive-category`, params: { category: data.type } })">
    ...
    <div v-else class="flex justify-around">
      <div class="mt-5 text-center">
        <h4 class="font-bold text-gray-700 mb-1">
          Nothing saved in drive storage.
        </h4>
