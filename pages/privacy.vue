<template>
  <div class="md:w-[90%] lg:w-[70%] m-auto mt-10">
    <img
    ...
    <div class="w-[800px] max-w-[90%] m-auto">
      ...
      <ul class="mb-5">
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to GETWELP LIMITED, 3rd
            Floor 86-90 Paul Street, London, England, EC2A 4NE.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Luna, accessible from
            <a
              href="www.goluna.app"
      ...
      <ul>
        <li>By email: support@goluna.app</li>
      </ul>
    </div>
  </div>
</template>
...
h1{
    @apply mb-2 mt-2 text-2xl font-bold;
}
h2{
    @apply mb-2 mt-2 text-xl font-bold;
}
