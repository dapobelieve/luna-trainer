  ...
  <div>
    <PageHeader>
      <template v-slot:back-button>
        ...
        >
          <path
            d="M7.87878 18.0001C7.67989 18 7.48915 17.921 7.34853 17.7803L1.21953 11.6513C0.516515 10.9481 0.121582 9.99443 0.121582 9.00006C0.121582 8.0057 0.516515 7.05204 1.21953 6.34881L7.34853 0.219811C7.48998 0.0831927 7.67944 0.00759688 7.87608 0.0093057C8.07273 0.0110145 8.26084 0.0898912 8.3999 0.228947C8.53895 0.368003 8.61783 0.556113 8.61954 0.75276C8.62125 0.949408 8.54565 1.13886 8.40903 1.28031L2.28003 7.40931C1.85822 7.83125 1.62126 8.40344 1.62126 9.00006C1.62126 9.59668 1.85822 10.1689 2.28003 10.5908L8.40903 16.7198C8.51389 16.8247 8.58529 16.9583 8.61422 17.1038C8.64315 17.2493 8.62829 17.4 8.57154 17.5371C8.51479 17.6741 8.41868 17.7912 8.29538 17.8736C8.17207 17.956 8.02709 18 7.87878 18.0001Z"
            fill="black"
          />
        </svg>
      </template>
    ...
    <div class="tail-overflow-hidden tail-flex tail-space-x-6 tail-px-5 tail-py-4" style="height: calc(100vh - 52px)">
      ...
      <!-- Main Content area -->
      <div class="tail-flex-1 tail-bg-white tail-rounded-lg">
        <main class="tail-flex-1 tail-overflow-y-auto">
